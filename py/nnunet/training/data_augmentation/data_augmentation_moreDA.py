...
from nnunet.training.data_augmentation.custom_transforms import Convert3DTo2DTransform, Convert2DTo3DTransform, \
    MaskTransform, ConvertSegmentationToRegionsTransform, RandomMotion, HistogramEqualization
...
def get_moreDA_augmentation(dataloader_train, dataloader_val, patch_size, params=default_3D_augmentation_params,
    ...
    print(f"Mona-4: moreDA augmentation \n{params}")
    tr_transforms = []
    ...
    if params.get("motion"):
        print("Mona-5: use the randomMotion")
        tr_transforms.append(RandomMotion())

    if params.get("do_histogram"):
        print("Mona-6: use the histogram")
        tr_transforms.append(HistogramEqualization()),
