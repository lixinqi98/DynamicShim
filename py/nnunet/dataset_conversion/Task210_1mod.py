...
if __name__ == '__main__':
    ...
    base = '/home/xinqili/dlmri/dlmri/nnUNet/nnUNet_data'
    # this folder should have the training and testing subfolders

    # now start the conversion to nnU-Net:
    task_name = 'Task210_final_1mod'
    ...
    image_folder = os.path.join(base, task_name, 'inputs_1mod')
    label_folder = os.path.join(base, task_name, 'labels_1mod')
    ...
    for idx, t in enumerate(images_mag):
        ...
        output_mag_file = join(target_imagesTr, unique_name + t[-12:]) 
        # output_phase_file = join(target_imagesTr, unique_name + images_phase[idx][-12:])
