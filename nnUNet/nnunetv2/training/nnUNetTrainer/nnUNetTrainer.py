...
class nnUNetTrainer(object):
    ...
    def configure_rotation_dummyDA_mirroring_and_inital_patch_size(self):
        ...
        initial_patch_size = get_patch_size(patch_size[-dim:],
                                            *rotation_for_DA.values(),
                                            (0.85, 1.25))
        self.print_to_log_file(f"Mona - get the initial patch size {initial_patch_size}")
    ...
    def get_dataloaders(self):
        ...
        patch_size = self.configuration_manager.patch_size
        self.print_to_log_file(f"Mona - get the patch size {patch_size}")
        dim = len(patch_size)
    ...
    def get_training_transforms(patch_size: Union[np.ndarray, Tuple[int]],
        ...
        # tr_transforms.append(ZoomTransform(zoom_factors=2))
        # print(f"Mona - Run the zoom Augmentation")
        ...
        # tr_transforms.append(RandScaleCrop(roi_scale=[0.3, 0.4, 0.5, 0.7, 0.8], random_size=False))
